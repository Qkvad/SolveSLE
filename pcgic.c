 ...
 * Project: prekondicionirana metoda konjugiranih gradijenata
 *
 *
...
integer pcg (integer n, doublereal* A, doublereal* b, doublereal* x0, doublereal tol){
    ...
    //kopiramo A u R jer ce nam A trebati
    dcopy_(&N,A,&inc,R,&inc);
    //saznaj koji je R iz ic
    ic(n,R);

    //rijesi Mp=r
    dcopy_(&n,r,&inc,p,&inc);
    trans='T'; uplo='U';
    dtrsv_(&uplo,&trans,&diag,&n,R,&n,p,&inc);
    trans='N';
    dtrsv_(&uplo,&trans,&diag,&n,R,&n,p,&inc);
